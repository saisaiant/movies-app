<div class="relative mt-3 md:mt-0">
    <input type="text" wire:model.debounce.500ms="search" class="bg-gray-800 rounded-full text-md w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search">
